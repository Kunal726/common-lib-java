...
@Slf4j
@NoArgsConstructor
public class CommonZookeeperConfig {
    @Value("${marketmosaic-common:default-value}")
    ...
    private static CommonZookeeperConfig instance;
    ...
    private static void initStaticInstance(CommonZookeeperConfig zooKeeperConfig) {
